...
public class ProductServiceImpl implements ProductService {
	...
	public List<Object[]> listadminproduct() {
		Session session = sessionFactory.getCurrentSession();
		String sqlQuery = "SELECT t.product_id,t.product_name,t.description,t.price,t.product_image,t.product_content,t.status FROM Tbl_Product t ORDER BY `product_id` DESC";
