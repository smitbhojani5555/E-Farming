...
<script>
	function updatetext() {
		...
		if (pt1) {
			...
			document.getElementById("userdoc1").style.display='block';
		} else {
			document.getElementById("agronomisttype").style.display='none';
			document.getElementById("userdoc1").style.display='none';
		}
		if(pt2)
			{
			document.getElementById("companyname1").style.display='block';
			document.getElementById("divfirstname1").style.display='none';
			document.getElementById("divlastname1").style.display='none';
			document.getElementById("lastname").removeAttribute('required');
			document.getElementById("firstname").removeAttribute('required');
			}
		else{
			document.getElementById("divfirstname1").style.display='block';
			document.getElementById("divlastname1").style.display='block';
	...
	<div class="row">
		<div class="col-md-3 top-social-icons text-center">
			<ul class="social-icons">
				<li class="mr-1"><a
					href="https://www.facebook.com/patel.smit.750"><span
						class="fab fa-facebook-f"></span></a></li>
				<li class="mx-1"><a href=""https://mail.google.com/mail/u/0/#inbox"><span
		...
		<div class="col-md-6 logo text-center">
			<h1>
				<a class="navbar-brand" href="home.htm"> <i class="fas fa-leaf"></i>E-Farming
				</a>
			</h1>
		</div>
		...
		<c:if test="${userid eq null}">
			<div class="col-md-3 login-right-img text-center">
				<a class="request text-uppercase" href="#" data-toggle="modal"
					...
					data-target="#exampleModalCenter2" onclick="updatetext();">Sign
					Up</a>
			</div>
		</c:if>
					...
					<form method="post">
						...
						<p class="text-center pb-4">
							<a href="#" data-toggle="modal"
								data-target="#exampleModalCenter2"> Don't Have An Account?</a></br> <a
								href="#" data-toggle="modal" data-target="#exampleModalCenter3">
								Forgot Password?</a>
						</p>
					</form>
				</div>
				...
				<div class="login px-4 mx-auto mw-100">
					...
					<form method="post" action="forgotpassword.htm">
						<div class="form-group">
							...
							Farmer &nbsp;&nbsp; <input type="radio" name="fusertype"
								value="2">&nbsp;Agronomist&nbsp;&nbsp; <input
								type="radio" name="fusertype" value="3">&nbsp;Company</br>
						</div>
						<div class="form-group">
							<label class="mb-2">Email address</label> <input type="email"
						...
						<button type="submit" class="btn btn-primary submit mb-4">Send
							Me Link</button>
						<p class="text-center pb-4">
					</form>
				</div>
					...
					<form name="myform" method="post" action="register.htm"
						...
						<div class="form-group">
							<label>Select Registration Type :</label> </br> <input type="radio"
								...
								onclick="updatetext()">&nbsp;Company</br>
							</br>
							<div class="form-group" id="divfirstname1">

								<label>FirstName :</label> <input type="text"
									class="form-control" id="firstname" name="firstname"
									placeholder="" required="">
							</div>
							<div class="form-group" id="divlastname1">
							...
							<div class="form-group" id="companyname1">
								<label>CompanyName :</label> <input type="text"
									class="form-control" id="cname" name="name" placeholder=""
									required="">
							</div>
						...
						<div class="form-group" id="userdoc1">
	...
	function userLogin() {
		...
		$.ajax({
			...
			if (result.response == true) {
				...
				alert('Invalid! Please enter valid credential');
			}
		});
	}
	debugger;
