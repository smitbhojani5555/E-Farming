  ...
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
       <form method="post" enctype="multipart/form-data" action="insertcompanyproduct.htm" id="myform" name="myform">
        ...
        <div class="modal-footer">
          <button type="subimt" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" id="button">Send Request</button>
